...
nme <- colnames(df)[colSums(is.na(df)) > 0]
...
table(df$FTR)
split <- createDataPartition(df$FTR, p = 0.9, list = F)
...
aml <- h2o.automl(x = x, y = y, training_frame = train_h2o,
                  nfolds = 5, max_runtime_secs = ((60*60)*9), stopping_metric = "logloss",
                  seed = 1234)

#model_id mean_per_class_error  logloss      rmse       mse
#1 DeepLearning_grid_1_AutoML_20190114_221949_model_37            0.5951226 1.090337 0.6491425 0.4213860
